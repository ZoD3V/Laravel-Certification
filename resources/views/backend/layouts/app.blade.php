    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="/admin/home" class="brand-link text-decoration-none">
                ...
                <span
                    class="brand-text ml-4 font-weight-light ">{{ Auth::user()->is_admin == 1 ? 'Admin Dashboard' : 'Staff Dashboard' }}</span>
            </a>
                        ...
                        @if (Auth::user()->is_admin == 1)
                            <li class="nav-item menu-open">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="{{ route('b.manage.user') }}"" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>User</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ route('b.manage.departement') }}" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p> Department</p>
                                        </a>
                                    </li>
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ route('b.manage.user_departement') }}" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>User Department</p>
                                        </a>
                                    </li>
